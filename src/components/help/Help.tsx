    ...
    <>
      <General>
        ...
        {activeTab === "Install" && (
          <>
            <HelpSection>
              <SelectionTitle>How to install SavageTome on desktop</SelectionTitle>
              <SectionText>
            ...
            <HelpSection>
              <SelectionTitle>How to install SavageTome on mobile</SelectionTitle>
              <SectionText>
        ...
        {activeTab === "Import" && (
          <>
            ...
            <HelpSection>
              ...
              <SectionText>
                As of now only SavageTome and 5eTools .json files are supported.
              </SectionText>
            </HelpSection>
          </>
        )}
        {activeTab === "Export" && (
          <>
            ...
            <HelpSection>
              ...
              <SectionText>As of now you can only export to SavageTome .json files.</SectionText>
            </HelpSection>
          </>
        )}
