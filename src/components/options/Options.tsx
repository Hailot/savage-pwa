      ...
      <OptionWrapper>
        ...
        <OptionSection>
          ...
          <SectionRow>
            ...
            <IconButton icon={faFileExport} onClick={() => exportAll("SavageTome_all.json")} />
          </SectionRow>
        </OptionSection>
        <OptionSection>
          ...
          <SectionRow>
            ...
            <IconButton
              icon={faFileExport}
              onClick={() => exportAllLeft("SavageTome_all_campagin.json")}
            />
          </SectionRow>
        </OptionSection>
        <OptionSection>
          ...
          <SectionRow>
            ...
            <IconButton
              icon={faFileExport}
              onClick={() => exportAllRight("SavageTome_all_entities.json")}
            />
          </SectionRow>
        </OptionSection>
        <OptionSection>
